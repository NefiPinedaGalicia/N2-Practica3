  ...
  return (
    <div className="flex gap-4">
      {icons.map((Icon, i) => (
        <div
          key={i}
          className="w-8 h-8 rounded-full border border-indigo-300 flex items-center justify-center text-[#a1bce5] hover:text-indigo-500 cursor-pointer transition-colors"
        >
          {Icon}
        </div>
      ))}
